...
/**
 * This class represents a lazily evaluated sequence of values of type A
 *
...
public final class Stream<A> {
	...
	/**
	 * This is a type constructor for an empty lazy sequence of type A
	 *
	...
	/**
	 * This is a type constructor for a lazy sequence of type A that prepends
	 * a value of type A to a lazy sequence of type A
	 *
	...
	/** The head of this lazy sequence as a Maybe, since this sequence could be empty */
